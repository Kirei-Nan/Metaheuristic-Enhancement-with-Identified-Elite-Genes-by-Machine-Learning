...
public class GAComparisonMainClass {
	public static String SRC = "./resource/";
	public static String INPUT_DIR = SRC + "input/";
	public static String instance = "eil101";// berlin52, eil76, eil101,bays29
...
////////////////////////////////////////////////////////////////////////////////		
		...
		Solution[] enhancedInput_GA = new Solution[datasize];
		Solution[] traditional_GA = new Solution[datasize];
...
////////////////////////////////////////////////////////////////////////////////Traditional		
			...
			traditional_GA[i] = ga.solve(initialSolution, convergeConfirm);
			end1 = System.currentTimeMillis();
			time1 += (end1 - start1);
			totalDistance1 += traditional_GA[i].getDistance();
////////////////////////////////////////////////////////////////////////////////Enhanced		
			start2 = System.currentTimeMillis();
			enhancedInput_GA[i] = ga.solve(enhancedGenerator[i], convergeConfirm);
			end2 = System.currentTimeMillis();
			time2 += (end2 - start2);
			totalDistance2 += enhancedInput_GA[i].getDistance();

		}

		System.out.println("Test datasize: " + datasize);
		System.out.println("Traditional GA distance average: " + totalDistance1 / datasize);
		System.out.println("Traditional GA time average: " + time1 * 1.0 / datasize + "ms");
		System.out.println("Enhanced Input GA distance average: " + totalDistance2 / datasize);
		System.out.println("Enhanced Input GA time average: " + time2 * 1.0 / datasize + "ms");
