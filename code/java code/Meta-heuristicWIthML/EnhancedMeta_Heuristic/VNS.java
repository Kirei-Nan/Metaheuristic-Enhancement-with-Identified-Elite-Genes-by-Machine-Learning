...
//		int kmax = 3;
	...
	public Solution enhancedSolve(Solution inital, int convergeConfirm, ArrayList<int[]> rule, int kmax, int cityNb) {
		Solution bestSolution;
...
//		int kmax = 3;
		int k;
		fix_solution = Solution.packageSolutions(rule, inital, cityNb);
