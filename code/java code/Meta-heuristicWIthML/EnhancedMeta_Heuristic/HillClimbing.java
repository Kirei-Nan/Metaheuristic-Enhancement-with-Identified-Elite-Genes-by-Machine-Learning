...
//		System.out.println("TraditionalTime: "+time);
	...
	public Solution solveArrayList(Solution current, ArrayList<int[]> rule, int k,int cityNb) {// s is inital solution
//		long start;
//		long end;
//		long time=0;
//		start=System.nanoTime();
		...
		int t = 0;// iteration times
		ArrayList<int[]> fix_solution = Solution.packageSolutions(rule, current, cityNb);
		boolean stop = false;
